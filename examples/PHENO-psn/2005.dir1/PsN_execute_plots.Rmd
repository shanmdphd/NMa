...
#Created 2019-01-28 at 17:44

rplots.level <- 1
xpose.runno <- '2005'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
pdf.title <- 'execute diagnostic plots run 2005'
working.directory<-'C:\\nma\\examples\\PHENO-psn\\2005.dir1\\'
model.directory<-'C:\\nma\\examples\\PHENO-psn\\'
results.directory <- 'C:\\nma\\examples\\PHENO-psn\\'
...
mod.prefix <- ''
tab.suffix <- ''
rscripts.directory <- 'C:/Portable_PKPD/PsN/PsN_4_8_8/R-scripts'
raw.results.file <- 'raw_results_2005.csv'
theta.labels <- c('THETA1','THETA2','THETA3','THETA4')
theta.fixed <- c(FALSE,FALSE,FALSE,FALSE)
omega.labels <- c('OMEGA(1,1)','OMEGA(2,1)','OMEGA(2,2)')
