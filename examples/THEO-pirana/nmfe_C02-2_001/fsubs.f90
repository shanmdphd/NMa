      ...
      REAL(KIND=DPSIZE), POINTER ::DOSE,V,K,KA,IPRED,Y,A000032,A000034
      REAL(KIND=DPSIZE), POINTER ::A000036,A000038,A000040,A000042
      REAL(KIND=DPSIZE), POINTER ::A000131,A000149,A000147,A000148
      REAL(KIND=DPSIZE), POINTER ::A000129,A000140,A000141,A000130
      REAL(KIND=DPSIZE), POINTER ::A000143,C000031,A000152,A000150
      REAL(KIND=DPSIZE), POINTER ::A000151,C000032
      CONTAINS
      ...
      A000040=>COM(000011);A000042=>COM(000012);A000131=>COM(000013)
      A000149=>COM(000014);A000147=>COM(000015);A000148=>COM(000016)
      A000129=>COM(000017);A000140=>COM(000018);A000141=>COM(000019)
      A000130=>COM(000020);A000143=>COM(000021);C000031=>COM(000022)
      A000152=>COM(000023);A000150=>COM(000024);A000151=>COM(000025)
      C000032=>COM(000026)
