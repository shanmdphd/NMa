      ...
      REAL(KIND=DPSIZE), POINTER ::DOSE,V,K,KA,IPRED,Y,CL,A000032
      REAL(KIND=DPSIZE), POINTER ::A000034,A000036,A000038,A000040
      REAL(KIND=DPSIZE), POINTER ::A000042,A000131,A000149,A000147
      REAL(KIND=DPSIZE), POINTER ::A000148,A000129,A000140,A000141
      REAL(KIND=DPSIZE), POINTER ::A000130,A000143,C000031,A000152
      REAL(KIND=DPSIZE), POINTER ::A000150,A000151,C000032,A000153
      REAL(KIND=DPSIZE), POINTER ::A000158,A000157,A000154,A000159
      CONTAINS
      SUBROUTINE ASSOCNMPRD4
      COM=>VRBL
      DOSE=>COM(000001);V=>COM(000002);K=>COM(000003);KA=>COM(000004)
      IPRED=>COM(000005);Y=>COM(000006);CL=>COM(000007)
      A000032=>COM(000008);A000034=>COM(000009);A000036=>COM(000010)
      A000038=>COM(000011);A000040=>COM(000012);A000042=>COM(000013)
      A000131=>COM(000014);A000149=>COM(000015);A000147=>COM(000016)
      A000148=>COM(000017);A000129=>COM(000018);A000140=>COM(000019)
      A000141=>COM(000020);A000130=>COM(000021);A000143=>COM(000022)
      C000031=>COM(000023);A000152=>COM(000024);A000150=>COM(000025)
      A000151=>COM(000026);C000032=>COM(000027);A000153=>COM(000028)
      A000158=>COM(000029);A000157=>COM(000030);A000154=>COM(000031)
      A000159=>COM(000032)
...
!                      A000128 = DERIVATIVE OF Y W.R.T. ETA(001)
      A000128=A000051 
!                      A000129 = DERIVATIVE OF Y W.R.T. ETA(002)
      A000129=EPS(001)*A000056+A000126 
!                      A000130 = DERIVATIVE OF Y W.R.T. ETA(003)
      A000130=EPS(001)*A000055+A000127 
!                      A000131 = DERIVATIVE OF Y W.R.T. ETA(001)
      A000131=EPS(001)*A000051+A000128 
!                      A000150 = DERIVATIVE OF C000031 W.R.T. ETA(002)
      A000150=A000056 
!                      A000151 = DERIVATIVE OF C000031 W.R.T. ETA(003)
      A000151=A000055 
!                      A000152 = DERIVATIVE OF C000031 W.R.T. ETA(001)
      A000152=A000051 
!                      A000153 = DERIVATIVE OF CL W.R.T. ETA(001)
      A000153=K*A000032 
!                      A000154 = DERIVATIVE OF CL W.R.T. ETA(002)
      A000154=V*A000036 
      G(001,1)=A000131
      G(002,1)=A000129
      G(003,1)=A000130
...
!                      A000132 = DERIVATIVE OF A000126 W.R.T. ETA(003)
      A000132=A000112 
!                      A000133 = DERIVATIVE OF A000126 W.R.T. ETA(002)
      A000133=A000111 
!                      A000134 = DERIVATIVE OF A000127 W.R.T. ETA(003)
      A000134=A000107 
!                      A000135 = DERIVATIVE OF A000128 W.R.T. ETA(001)
      A000135=A000079 
!                      A000136 = DERIVATIVE OF A000128 W.R.T. ETA(003)
      A000136=A000077 
!                      A000137 = DERIVATIVE OF A000128 W.R.T. ETA(002)
      A000137=A000076 
!                      A000138 = DERIVATIVE OF A000129 W.R.T. ETA(003)
      A000138=EPS(001)*A000112 
!                      A000139 = DERIVATIVE OF A000129 W.R.T. ETA(002)
      A000139=EPS(001)*A000111 
!                      A000140 = DERIVATIVE OF A000129 W.R.T. ETA(002)
      A000140=A000133+A000139 
!                      A000141 = DERIVATIVE OF A000129 W.R.T. ETA(003)
      A000141=A000132+A000138 
!                      A000142 = DERIVATIVE OF A000130 W.R.T. ETA(003)
      A000142=EPS(001)*A000107 
!                      A000143 = DERIVATIVE OF A000130 W.R.T. ETA(003)
      A000143=A000134+A000142 
!                      A000144 = DERIVATIVE OF A000131 W.R.T. ETA(001)
      A000144=EPS(001)*A000079 
!                      A000145 = DERIVATIVE OF A000131 W.R.T. ETA(003)
      A000145=EPS(001)*A000077 
!                      A000146 = DERIVATIVE OF A000131 W.R.T. ETA(002)
      A000146=EPS(001)*A000076 
!                      A000147 = DERIVATIVE OF A000131 W.R.T. ETA(002)
      A000147=A000137+A000146 
!                      A000148 = DERIVATIVE OF A000131 W.R.T. ETA(003)
      A000148=A000136+A000145 
!                      A000149 = DERIVATIVE OF A000131 W.R.T. ETA(001)
      A000149=A000135+A000144 
!                      A000157 = DERIVATIVE OF A000153 W.R.T. ETA(002)
      A000157=A000032*A000036 
!                      A000158 = DERIVATIVE OF A000153 W.R.T. ETA(001)
      A000158=K*A000034 
!                      A000159 = DERIVATIVE OF A000154 W.R.T. ETA(002)
      A000159=V*A000038 
!                      A000149 = 2ND DERIV OF F W.R.T. ETA(001), ETA(001)
      G(001,002)=A000149
!                      A000147 = 2ND DERIV OF F W.R.T. ETA(002), ETA(001)
      G(002,002)=A000147
!                      A000140 = 2ND DERIV OF F W.R.T. ETA(002), ETA(002)
      G(002,003)=A000140
!                      A000148 = 2ND DERIV OF F W.R.T. ETA(003), ETA(001)
      G(003,002)=A000148
!                      A000141 = 2ND DERIV OF F W.R.T. ETA(003), ETA(002)
      G(003,003)=A000141
!                      A000143 = 2ND DERIV OF F W.R.T. ETA(003), ETA(003)
      G(003,004)=A000143
      ENDIF
      H(001,1)=C000031
      H(002,1)=C000032
