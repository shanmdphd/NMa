...
$TAB ID TIME MDV IPRED IWRES CWRES
     FILE=sdtabC07-3 NOPRINT ONEHEADER
$TAB ID CL V KA K ETA(1) ETA(2) ETA(3)
     FILE=patabC07-3 NOPRINT ONEHEADER NOAPPEND
$TAB ID BWT
     FILE=cotabC07-3 NOPRINT ONEHEADER NOAPPEND
$TAB ID
     FILE=catabC07-3 NOPRINT ONEHEADER NOAPPEND
