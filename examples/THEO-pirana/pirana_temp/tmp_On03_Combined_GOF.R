...
models <- list ( 
  "C01-2" = list ( 
    ...
    data_file       = "THEO",
    output_file     = "C01-2.lst",
    tables          = c("sdtabC01-2"),
    estim           = list(
      th          = c(3.17E+00, 3.83E+01, 1.05E-01),
      th_se       = c(6.41E-01, 1.69E+00, 2.31E-02),
      om          = c(1.2, 0.0313, 0.251),
      om_se       = c(0.421,0.0198,0.289),
      om_block    = matrix(c( 1.2, 0.137, 0.37,
                              0.137, 0.0313, 0.0434,
                              0.37, 0.0434, 0.251), ncol=3),
      om_se       = c(0.421,0.0198,0.289),
      si          = c( 0.0121,  0.0543),
