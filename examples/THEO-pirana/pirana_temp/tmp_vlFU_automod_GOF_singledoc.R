...
fname <- paste0("pirana_reports/automod_GOF_",paste0(format(Sys.time(), "%Y%m%d"), "_", (gsub(":", "", format(Sys.time(), "%X")))),".pdf")
...
# R code for plotting starts here
    ...
    ## Print the GOF plots to the PDF
    ...
    pl5 <- xyplot (DV+IPRED~TIME | factor(ID), data=tab,
