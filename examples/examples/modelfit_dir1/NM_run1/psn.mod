...
$ESTIMATION METHOD=ITS INTER LAP NITER=1000 PRINT=5 SIGL=6 NSIG=2
...
$ESTIMATION METHOD=IMP INTER LAP NITER=1000 PRINT=1 ISAMPLE=300 DF=4
            IACCEPT=1.0
$ESTIMATION METHOD=IMP EONLY=1 NITER=5 ISAMPLE=1000 PRINT=1 DF=4
            IACCEPT=1.0 MAPITER=0
$ESTIMATION METHOD=SAEM EONLY=0 INTER LAP NBURN=2000 NITER=1000
            PRINT=50 DF=0 IACCEPT=0.4
$ESTIMATION METHOD=IMP EONLY=1 NITER=5 ISAMPLE=1000 PRINT=1 DF=4
            IACCEPT=1.0 MAPITER=0
$ESTIMATION METHOD=BAYES NBURN=3000 NSAMPLE=3000 PRINT=100
            FILE=example10.txt DF=0 IACCEPT=0.4 NOPRIOR=0
$ESTIMATION METHOD=COND LAP INTER MAXEVAL=9999 PRINT=1 FILE=psn.ext
            NOPRIOR=1 NOHABORT
$COVARIANCE UNCONDITIONAL PRINT=E MATRIX=R SIGL=10
