...
#Created 2018-10-19 at 16:20

rplots.level <- 1
xpose.runno <- '10'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
pdf.title <- 'execute diagnostic plots run 10'
working.directory<-'C:\\nma\\examples\\examples\\modelfit_dir1\\'
model.directory<-'C:\\nma\\examples\\examples\\'
results.directory <- 'C:\\nma\\examples\\examples\\'
model.filename<-'example10.ctl'
subset.variable<-NULL
mod.suffix <- '.ctl'
mod.prefix <- 'example'
tab.suffix <- ''
rscripts.directory <- 'C:/STRAWB~1/perl/site/lib/PsN_4_8_1/R-scripts'
raw.results.file <- 'raw_results_example10.csv'
