      ...
      <body>
        ...
        <table border="1" >
          <tr style="font-size: 10pt; font-family: tahoma; font-weight: bold; background-color: aqua">
            ...
            <td style="text-align: center">InSig</td>
            <td style="text-align: center">Border</td>
            <td style="text-align: center">Unitary</td>
          ...
          <xsl:for-each select="outputs/output">
            ...
            <tr style="font-size: 10pt; font-family: verdana">
              ...
              <td style="text-align: center">
                <xsl:if test="minimize = 'True'">
                  <xsl:attribute name="style">
                    <xsl:text>color:blue; font-weight:bold; text-align: center</xsl:text>
                  </xsl:attribute>
                </xsl:if>
              ...
              <td style="text-align: center"><xsl:value-of select="AICc"/></td>
              ...
              <td style="text-align: center"><xsl:value-of select="sig"/></td>
              <td style="text-align: center"><xsl:value-of select="insig"/></td>
              <td style="text-align: center"><xsl:value-of select="border"/></td>
              <td style="text-align: center"><xsl:value-of select="unitary"/></td>
              <td style="text-align: center"><xsl:value-of select="fixedones"/></td>
            </tr>
          </xsl:for-each>
        </table>
        </center>
